...
class Qwen3TTS:
    ...
    def generate_icl_prompt(self, text_id, ref_id, ref_code, tts_pad_embed, tts_eos_embed):
        ...
        self.talker_io.set_input_blob_shape(self.zero_hidden.shape, 1)
        text_proj = self.talker_io.run([text_emb, self.zero_hidden])[0]
