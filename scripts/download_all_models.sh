...
cd ../../face_recognition/ailia_age_gender; python3 ailia_age_gender.py ${OPTION}
...
cd ../../generative_adversarial_networks/ailia_glasses_removal; python3 ailia_glasses_removal.py ${OPTION}
