...
class SAM3VideoPredictor():
    ...
    def init_state(self, num_maskmem=7, max_obj_ptrs_in_encoder=16, version='2.1'):
        """
        Set default state from yaml.
        """
    ...
    def append_image(self, inference_state, image, video_height, video_width, image_encoder):
    ...
    def propagate_in_video_preflight(self, inference_state, image_encoder, prompt_encoder, mask_decoder, memory_attention, memory_encoder, mlp, obj_ptr_tpos_proj):
        assert memory_encoder is not None
        """
